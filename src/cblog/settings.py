...
DATABASES = {
    'default': {
        ...
        'HOST': 'aws-capstone-rds.cb3vzcye7olo.us-east-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'kurtblog' # please enter your s3 bucket name
